...
public struct ChatQuery: Equatable, Codable, Streamable, Sendable {
    ...
    /// models](https://platform.openai.com/docs/guides/reasoning). Currently supported values are
    /// none, minimal, low, medium, and high. Reducing reasoning effort can result in faster
    ...
    ///
    /// Note that you will be charged based on the number of generated tokens across all of the
    ...
    /// Configuration for a Predicted Output, which can greatly improve response times when large
    /// parts of the model response are known ahead of time. This is most common when you are
    ...
    /// which ensures the model will match your supplied JSON schema. Learn more in the [Structured
    /// Outputs guide](https://platform.openai.com/docs/guides/structured-outputs).
    ///
    /// Setting to `{ "type": "json_object" }` enables the older JSON mode, which ensures the
    /// message the model generates is valid JSON. Using `json_schema` is preferred for models that
    /// support it.
    ...
    /// distillation](https://platform.openai.com/docs/guides/distillation) or
    ...
    /// means the model can pick between generating a message or calling a function. `required`
    /// means the model must call one or more tools. Specifying a particular function via `{"type":
    ...
    ///
    /// Currently, only functions are supported as a tool. Use this to provide a list of functions
    ...
    /// See the [Streaming section](https://platform.openai.com/docs/api-reference/chat/streaming)
    /// for more information, along with the [streaming
    /// responses](https://platform.openai.com/docs/guides/streaming-responses) guide for more
    ...
    /// audio](https://platform.openai.com/docs/guides/audio). To request that this model generate
    /// both text and audio responses, you can use: `["text", "audio"]`
    public var modalities: [Self.ChatCompletionModalities]?

    public let thinking: [String: String]?
    ...
    public init(
        ...
        if let reasoningEffort, model.lowercased().contains("deepseek") {
            var thinkTem = ["type": "enabled"]
            switch reasoningEffort {
            case .none, .minimal:
                self.reasoningEffort = nil
                thinkTem = ["type": "disabled"]
            case .low, .medium:
                self.reasoningEffort = .high
            case .high:
                self.reasoningEffort = .customValue("max")
            case .customValue:
                self.reasoningEffort = reasoningEffort
            }
            self.thinking = thinkTem
        }else{
            self.reasoningEffort = reasoningEffort
            self.thinking = nil
        }
    ...
    public enum ChatCompletionMessageParam: Codable, Equatable, Sendable {
        ...
        public struct UserMessageParam: Codable, Equatable, Sendable {
            ...
            public enum Content: Codable, Equatable, Sendable {
                public enum ContentPart: Codable, Hashable, Sendable {
                    ...
                    /// Learn about [file inputs](https://platform.openai.com/docs/guides/text) for
                    /// text generation.
        ...
        public enum TextContent: Codable, Equatable, Sendable {
            ...
            /// An array of content parts with a defined type. For system, developer messages, only
        ...
        public struct AssistantMessageParam: Codable, Equatable, Sendable {
            ...
            public struct ToolCallParam: Codable, Equatable, Sendable {
                ...
                public init(from decoder: any Decoder) throws {
                    ...
                    // Some API providers for some AI models (e.g. openrouter.ai for Qwen model,
                    // mistral.ai for their models) don't return id and type parameters for
                    // ToolCallParam.
                    // See https://github.com/MacPaw/OpenAI/pull/366
                    self.id = try container.decodeString(
                        forKey: .id,
                        parsingOptions: parsingOptions
                    )
                    self.function = try container.decode(FunctionCall.self, forKey: .function)
                    self.type = try container
                        .decodeIfPresent(ToolsType.self, forKey: .type) ?? .function
                }
    ...
    public enum ReasoningEffort: Codable, Equatable, Sendable {
        ...
        /// For example, Gemini Flash 2.5 has "reasoning-disabled" mode. A developer would use
        /// `ReasoningEffort.customValue("reasoning-disable")` to specify the mode.
    ...
    public enum ResponseFormat: Codable, Hashable, Sendable {
        ...
        /// about [Structured Outputs](https://platform.openai.com/docs/guides/structured-outputs).
    ...
    public struct StructuredOutputConfigurationOptions: Codable, Hashable, Sendable {
        ...
        public init(
            ...
            schema: JSONSchemaDefinition? = nil,
            strict: Bool? = nil
        ) {
            self.name = name
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            case .function(let name):
                var container = encoder
                    .container(keyedBy: Self.ChatCompletionFunctionCallNameParam.CodingKeys.self)
    ...
    public struct ChatCompletionToolParam: Codable, Equatable, Sendable {
        ...
        public struct FunctionDefinition: Codable, Equatable, Sendable {
            ...
            /// Structured Outputs in the [function calling guide](https://platform.openai.com/docs/api-reference/chat/docs/guides/function-calling).
            ///
            /// Defaults to false
    ...
    public struct StreamOptions: Codable, Equatable, Sendable {
        ...
        ///
        /// - Note: If the stream is interrupted, you may not receive the final usage chunk which
    ...
    public enum PredictedOutputConfig: Codable, Hashable, Sendable {
        public struct StaticContent: Codable, Hashable, Sendable {
            public enum Content: Codable, Hashable, Sendable {
                ...
                case textContent(String)
                /// An array of content parts with a defined type. Supported options differ based on
                /// the [model](https://platform.openai.com/docs/models) being used to generate the
            ...
            /// The content that should be matched when generating a model response. If generated
            /// tokens would match this content, the entire model response can be returned much more
            /// quickly.
            let content: Content
